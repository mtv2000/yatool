...
- [Описаны правила превращения исходных файлов в результаты.](#Описание-макросов-ya.make-для-модуля)
...
#### Описание макросов ya.make для модуля
...
- Параметры командной строки, которые могут быть переданы в процесс тестирования (`SET()`)
