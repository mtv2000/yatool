...
- Все входы команд анализируются на предмет зависимостей в соответствии с их расширениями, а найденные имена файлов превращаются в зависимости в соответствии с ADDINCL данного модуля.
